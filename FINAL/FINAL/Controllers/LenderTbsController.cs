...
namespace FINAL.Controllers
{
    public class LenderTbsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LenderId,FirstName,LastName,EmailId,ContactNumber,Address")] LenderTb lenderTb)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LenderId,FirstName,LastName,EmailId,ContactNumber,Address")] LenderTb lenderTb)
        {
