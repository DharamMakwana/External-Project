...
namespace BorrowerPanel1.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InstrumentId,InstrumentName,LenderId,Description,AvailabilityStatus,Image,RentAmount")] Instruments instruments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstrumentId,InstrumentName,LenderId,Description,AvailabilityStatus,Image,RentAmount")] Instruments instruments)
        {
